...
if(filemtime("templates/default/home.html") > filemtime(__file__) || (file_exists("models/home.php") && filemtime("models/home.php") > filemtime(__file__)) ) {
	tpl_engine("default","home.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
